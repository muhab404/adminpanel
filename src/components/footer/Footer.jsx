  ...
  return (
    <footer className="text-center text-lg-start footer-bg text-white pt-4">
            ...
            <div className="col-md-3 col-lg-4 col-xl-3 mx-auto mb-4">
              ...
              <div className="phone_container">
                <div className="phone d-flex text-center ">
                  ...
                  <div className="ms-3">
                    <p className="mb-0 h4">+048 000000</p>
                    <p>Got Questions? </p>
                  </div>
                </div>
              </div>
              ...
              <div className="social_container mt-3 ">
                <div className="social d-flex  ">
                  <div className="socialIcon d-flex m-1 justify-content-center align-items-center">
                    <a href="https://www.facebook.com/profile.php?id=100015192994868">
                      <FaFacebook />
                    </a>
                  </div>
                  <div className="socialIcon d-flex m-1 justify-content-center align-items-center">
                  ...
                  <div className="socialIcon d-flex m-1 justify-content-center align-items-center">
                    <a href="https://www.instagram.com/muhabseif/">
                      <BsInstagram />
                    </a>
                  </div>
                  <div className="socialIcon d-flex m-1 justify-content-center align-items-center">
                    <a href="https://wa.me/+201280401638">
                      <BsTelephone />
                    </a>
                  </div>
                </div>
      ...
      <div className="text-center p-4 cobyRight">
        © 2022 Copyright:
        <p className="text-reset fw-bold">ITI Group5 2022</p>
      </div>
    </footer>
  );
};
